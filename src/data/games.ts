...
export const GAMES: Game[] = [
  ...
  },
  {
    slug: 'powder',
    title: 'Powder',
    blurb: 'Thirty-seven materials, and eight problems to solve',
    description:
      'A falling-sand sandbox with real emergent chemistry. Oil floats on water. Lava turns sand into glass. Salt kills plants, a spark runs through metal, and thermite burns through everything. Fifty-three reactions to find, and eight scenarios that hand you a grid, take away most of the palette and set you a problem.',
  ...
  },
  {
    slug: 'rule-cascade',
    title: 'Rule Cascade',
    blurb: 'Thirty-one rules. One of them eats your typing.',
    description:
      'It is just a username field. Then it wants a prime number, then the time, then a chess square. Then a moth gets in and starts eating characters, and a letter of the alphabet is taken away from you permanently. Thirty-one rules, and none of them ever switches off.',
