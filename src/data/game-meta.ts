...
export const SHELL_GAMES = new Set(['rule-cascade', 'auction', 'dark-patterns', 'trolley', 'not-a-robot', 'from-memory', 'steady-hand', 'paper-folds', 'constellation-draw', 'asteroid', 'deep-sea', 'space-elevator'])
